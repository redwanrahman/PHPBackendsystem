...
class adminBack{
    ...
    function admin_login($data){
        ...
        if(mysqli_query($this->conn,$query)){
            ...
            if($admin_info){
                ...
                $_SESSION['adminEmail'] = $admin_info
                ['admin_email'];
                $_SESSION['adminPass'] = $admin_info
                ['admin_pass'];
            }else{
    ...
    function add_product($data){
        ...
        if($pdt_ext == 'jpg' or $pdt_ext== 'png' or $pdt_ext== 'jpeg'){
            ...
            $msg = "Your File Be Must Be a JPG or PNG Otherwise JPEG File!";
            return $msg;
        }
    }

    function display_product(){
        $query = "SELECT * FROM products_info_ctg";
        if(mysqli_query($this->conn, $query)){
    ...
    function getEditProduct_info($id){
        $query = "SELECT * FROM products_info_ctg WHERE pdt_id=$id";
        if(mysqli_query($this->conn, $query)){
