...
--
-- Host: 127.0.0.1
-- Generation Time: Jun 09, 2021 at 03:54 PM
...
(1, 'Men items', 'New Product come for sale', 1),
(2, 'Women items', 'Women New Product come for sale', 1),
(3, 'Laptop', 'here comes laptop brand new', 1),
(4, 'Mobile Phone', 'Brand new Product come for sale', 1),
(5, 'Gadget', 'New technology gadget for sale', 1);
...
--
ALTER TABLE `products`
  MODIFY `pdt_id` int(255) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
COMMIT;
